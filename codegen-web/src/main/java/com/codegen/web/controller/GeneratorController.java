...
public class GeneratorController {
  ...
  public void generate(@RequestBody TableInfo tableInfo, HttpServletResponse response)
      throws Exception {
    // Prepare data model
    ...
    try (ZipOutputStream zos = new ZipOutputStream(response.getOutputStream())) {
      ...
      ZipEntry entry =
          new ZipEntry("src/main/java/com/example/entity/" + tableInfo.getClassName() + ".java");
